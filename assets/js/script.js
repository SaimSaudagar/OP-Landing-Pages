...
document.addEventListener("DOMContentLoaded", () => {
  const elementsToAnimate = document.querySelectorAll(
    ".feature-card, .about-content, .contact-content, .section-header"
  );
...
function animateCounters() {
  ...
  counters.forEach((counter) => {
    const updateCount = () => {
      const target =
        +counter.getAttribute("data-target") || parseInt(counter.textContent);
...
// Add CSS for notification styling only
